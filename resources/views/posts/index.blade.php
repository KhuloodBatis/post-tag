                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-success"
                                            href="{{ route('post.show', ['slug' => $item->slug]) }}"> <i
                                                class="fas  fa-2x fa-eye"></i> </a>

                                        <!-- here to do Authraztion for users edit & delete -->
                                        @if ($item->user_id == Auth::id())
                                            &nbsp;&nbsp;
                                            <a href="{{ route('post.edit', ['id' => $item->id]) }}"> <i
                                                    class="fas fa-2x fa-edit"></i> </a>&nbsp;&nbsp;
                                            <a class="text-danger"
                                                href="{{ route('post.destroy', ['id' => $item->id]) }}"> <i
